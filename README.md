### YTdown - YouTube视频下载工具

#### 项目描述
YTdown是一个功能强大的Python命令行工具，专为高效下载YouTube视频而设计。它不仅能下载高清视频和封面，还能自动翻译标题、整理元数据，并提供直观的进度显示。支持Windows/macOS/Linux系统，特别适合内容创作者、研究人员和视频爱好者使用。
